...
export default function Footer() {
    return (
        <footer className="mt-auto py-12 px-6 lg:px-20 border-t border-white/5 bg-[#050505] relative z-10">
            <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <p className="text-xs text-slate-600">© 2024 ACM-Certify. All rights reserved.</p>
            </div>
        </footer>
    );
}